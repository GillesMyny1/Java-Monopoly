...
public class Game extends DefaultHandler implements java.io.Serializable {
    ...
    public static Board importFromXmlFile(Integer versionNum) throws Exception {
        ...
        if(versionNum == 0) {
            ...
            //Canada Version
            in = ClassLoader.getSystemResourceAsStream(CANADA_XML);
            if (in == null) {
                in = new FileInputStream(CANADA_XML);
            }
            b.clearBoard();
        } else if(versionNum == 2) {
            //UK Version
            in = ClassLoader.getSystemResourceAsStream(UK_XML);
            if (in == null) {
                in = new FileInputStream(UK_XML);
            }
            b.clearBoard();
        }
        ...
        DefaultHandler dh = new DefaultHandler() {
            ...
            public void characters(char[] ch, int start, int length) {
                if (setCurrency) { b.setCurrencyInUse(new String(ch, start, length)); }
    ...
    /**
     * Check if an object equals the current game.
     *
     * @param o Object, the object to compare.
     * @return Boolean, true if the object is equal, false otherwise.
     */
    @Override
    public boolean equals(Object o) {
        ...
        Game game = (Game) o;
        return getCurrentPlayer() == game.getCurrentPlayer() && getDiceRoll() == game.getDiceRoll() && BAIL == game.BAIL && getDoubleCounter() == game.getDoubleCounter() && totalProperties == game.totalProperties && getDoublesRolled() == game.getDoublesRolled() && maxPlayers == game.maxPlayers && getPrice() == game.getPrice() && Objects.equals(getBoard(), game.getBoard()) && Objects.equals(currentOwnable, game.currentOwnable) && Objects.equals(getProp1(), game.getProp1()) && Objects.equals(getProp2(), game.getProp2()) && Objects.equals(getProp3(), game.getProp3()) && Objects.equals(pieces, game.pieces) && Objects.equals(views, game.views);
    }
