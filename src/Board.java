...
public class Board implements java.io.Serializable {
    ...
    /**
     * Check if an Object is equal to this board.
     *
    ...
    public boolean equals(Object o) {
        ...
        Board board = (Board) o;
        return Objects.equals(tileList, board.tileList) && Objects.equals(set1, board.set1) && Objects.equals(set2, board.set2) && Objects.equals(set3, board.set3) && Objects.equals(set4, board.set4) && Objects.equals(set5, board.set5) && Objects.equals(set6, board.set6) && Objects.equals(set7, board.set7) && Objects.equals(set8, board.set8);
    }
    ...
    /**
     * Get currency in use.
     * @return String, the currency in use.
     */
    public String getCurrencyInUse() {
        return currencyInUse;
    }

    /**
     * Set the currency in use.
     * @param currencyInUse String, the currency to set.
     */
    public void setCurrencyInUse(String currencyInUse) {
